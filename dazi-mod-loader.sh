...
# if [[ "$2" == *"lzdoom-addon"* ]] || [[ "$2" == *"lzdoom-dazi"* ]]; then echo "$3" > /dev/shm/runcommand.log && sudo /home/pi/RetroPie-Setup/retropie_packages.sh retropiemenu launch "/opt/retropie/configs/ports/doom/dazi-mod-loader.sh" </dev/tty > /dev/tty; fi #For Use With [lzdoom-dazi] + [ExitWithoutLaunching] #Line Should be LAST
